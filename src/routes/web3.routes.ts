...
//   validateABI,
//   validateWeb3Request,
// } from "../middleware/web3.middleware";
...
// router.get("/status", web3Controller.getNetworkStatus);
...
// router.get("/transactions/:txHash", web3Controller.getTransactionStatus);
...
// // Get contract ABI
// router.get("/contracts/:contractName/abi", web3Controller.getContractABI);
...
//   try {
//     const addresses = {
//       accessControl: await contractService
//         .getContract("accessControl")
//         .getAddress(),
//       mockStablecoin: await contractService
//         .getContract("mockStablecoin")
//         .getAddress(),
//       employerRegistry: await contractService
//         .getContract("employerRegistry")
//         .getAddress(),
//       cngnOnRamp: await contractService.getContract("cngnOnRamp").getAddress(),
//       reserveFund: await contractService
//         .getContract("reserveFund")
//         .getAddress(),
//       advanceEngine: await contractService
//         .getContract("advanceEngine")
//         .getAddress(),
//       web3LiquidityPool: await contractService
//         .getContract("web3LiquidityPool")
//         .getAddress(),
//     };
...
//     res
//       .status(500)
//       .json({ status: "error", message: "Failed to get contract addresses" });
//   }
// });
...
//     res
//       .status(500)
//       .json({ status: "error", message: "Failed to get wallet balance" });
//   }
// });
...
//     const tokenAddress = await contractService
//       .getContract("mockStablecoin")
//       .getAddress();
...
//     res
//       .status(500)
//       .json({ status: "error", message: "Failed to get token balance" });
//   }
// });
